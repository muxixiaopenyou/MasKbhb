...
def run_gat_experiment(n_layers, batch_size, lr, weight_decay, n_epochs, k_folds,
    ...
    logger.info("=" * 60)
    logger.info(f"GAT LAYERS: {n_layers}")
    logger.info("=" * 60)
...
def main():
    ...
    for n_layers in GAT_LAYERS:
        result = run_gat_experiment(
            n_layers=n_layers,
            batch_size=batch_size,
            lr=lr,
    ...
    with open(summary_path, 'w', encoding='utf-8') as sf:
        ...
        slog("=" * 70)
        slog("FINAL COMPARISON: GAT LAYERS vs PERFORMANCE")
        slog("=" * 70)

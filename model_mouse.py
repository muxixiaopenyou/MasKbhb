...
class EmbeddingGraphBranch(nn.Module):
    def __init__(self, node_dim=1280, edge_dim=16, hidden_dim=128, num_layers=2, heads=4):
        super().__init__()
...
class OneHotCNNBranch(nn.Module):
    def __init__(self, in_dim=21, out_dim=128, center_idx=20, seq_len=41, num_transformer_layers=3):
        super().__init__()
